...
def resp_200(code: int = 20000, data: Union[Type[SchemasType], Any] = None,
             msg: str = "Success"):
    return {"code": code, "data": data, "msg": msg}


def resp_400(code: int = 20000, data: str = None,
